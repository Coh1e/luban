...
// Marker block engine moved to src/marker_block.{hpp,cpp} so it can be
// unit-tested independently. The two free functions are aliased here for
// readability of the call sites below.
using luban::marker_block::extract_template_blocks;
using luban::marker_block::sync_managed_blocks;
