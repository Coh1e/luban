...
void register_new() {
    ...
    c.group = "project";
    // Manual-grade --help: `templates/help/new.md` is embedded at build
    // time via cmake/embed_text.cmake — single source of truth for the
    // long-form `luban new --help` output.
